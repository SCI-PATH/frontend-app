/**
 * Launch from SCI-PATH Next.js (frontend-app) via URL query params.
 *
 * Example:
 *   http://localhost:5173/?studentId=abc&username=alex&displayName=Alex&sessionId=sess_xyz&topicId=plant_biology&grade=7&source=frontend-app
 */
